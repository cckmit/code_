...
<head>
	<title>Full Search - 404 - page not found</title>
...
<section style="width: 100%;background: #fff;text-align: center;overflow: hidden;">
	<div class="container" style="position:relative;width: 1140px;height: 400px;overflow: hidden;">
			<img src="<%=basePath%>/images/site/4041.png" alt="" style="width: 1000px;height: auto;margin-top:-70px;">
			<%--<p class="nrml-txt">Why not try refreshing you page? Or you can <a href="#">contact our support</a> if the problem persists.</p>--%>
		<a href="#" onclick="javascript:window.history.back();"  style="dispaly:block;width: 150px;height: 40px;text-align: center;line-height: 40px;color: #fff;position: absolute;left: 50%;margin-left: -75px;bottom: 0;background: #1ABC9C;font-size: 18px;font-weight: bold;box-shadow: 0 5px 5px #8DD9CA">BACK</a>
