...
<html>
<head>
    <title>Full Search - OrderDetailListChina</title>
    ...
    <script src="<%=basePath%>js/manager/orderDetailListChina.js"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#orderDetailLiChina").addClass("nav-active");
        if(orderLevel == 2 && orderStatusId == 1)
            $("#orderDetailListLiChina1").addClass("active");
        else
            $("#orderDetailListLiChina2").addClass("active");
    });
</script>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <input type="hidden" id="isChinaOrder" name="isChinaOrder" value="是">
