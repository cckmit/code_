...
<html>
<head>
    <title>Full Search - OrderDetailListCustom</title>
    ...
    <script type="text/javascript" src="<%=basePath%>js/manager/orderDetailListCustom.js"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#orderDetailLiCustom").addClass("nav-active");
        if(orderLevel == 2 && orderStatusId == 1)
            $("#orderDetailListLiCustom1").addClass("active");
        else
            $("#orderDetailListLiCustom2").addClass("active");
    });
</script>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <input type="hidden" id="isCustomOrder" name="isCustomOrder" value="是">
