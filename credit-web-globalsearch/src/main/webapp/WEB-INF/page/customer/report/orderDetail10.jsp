        ...
        <div class="slimScrollBar">
            <div class="scrollable">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td colspan="6" align="center" style="padding: 15px 0;background: #fff;"><img
                                src="${pageContext.request.contextPath}/images/creditRatingEN/${creditAssessments.globalSolvency}<c:if test="${empty creditAssessments.globalSolvency}">0</c:if>.jpg"
                                width="100%"
                                alt=""/>
                        </td>
                    </tr>
                    <tr>
                        <td ><strong>Solvency Index</strong>
                        </td>
                        <td>${creditAssessments.globalSolvency}</td>
                    </tr>
                    <tr>
                        <td ><strong>Risk
                            Assessment</strong>
                        </td>
                        <td >${creditAssessments.creditRatingEN}</td>
                    </tr>
                    <tr>
                        <td>
                            <strong>Recommended Line</strong>
                        </td>
                        <td style="text-indent:10px;">
                            <c:if test="${creditAssessments.resultRecommended !=''}">
                                <fmt:formatNumber value="${creditAssessments.resultRecommended}" pattern="#,#00"/>
                            </c:if>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6" style="color: #878787;font-size: 12px;font-style: italic">
                            ...
                            <p style="width: 93%;float:right;padding-right: 20px;">
                                ...
                                Classified Management of Enterprises” published on April 1st,2008, the followings are
                                the
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-hover table-striped table-responsive">
                    <tbody>
                    <%--<tr>--%>
                        <%--<td style="border-bottom:1px solid #ecf0f1;padding-bottom:10px;">--%>
                                <%--${creditAssessments.creditOpinionEN}--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    <tr>
                        <td style="color: #878787;font-size: 12px;font-style: italic;padding-top:10px">
                            ...
                            <p style="width: 93%;float:right;padding-right: 20px;margin-bottom:0">
                                This is just a credit opinion formed based on the information collected in this
                                report.
                                The actual credit decision would vary and determined by the user based on
    ...
    <div class="tab-pane fade in" id="Industry">
        <div class="row">
            <div class="panel-group" role="tablist" aria-multiselectable="true">
                    <%--Current Operation--%>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="fxqOne">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion"
                               href="#current"
                               aria-expanded="true"
                    ...
                    <div id="current" class="panel-collapse collapse" role="tabpanel" aria-labelledby="fxqOne">
                        <div class="panel-body">
                            <c:if test="${not empty operatings}">
                                <table class="table table-hover table-striped table-responsive fxq-report-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>${operatings.companyStatusEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Main Business:</td>
                                        <td>${operatings.mainDiscriptionEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Main Products:</td>
                                        <td>${operatings.mainProductEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Production:</td>
                                        <td>${operatings.productionEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Main Activity:</td>
                                        <td>${operatings.activityOneEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Info from Internet:</td>
                                        <td>${operatings.infoEN}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>${operatings.purchaseDomesticEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">International:</td>
                                        <td>${operatings.purchaseInternationlEN}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td width="20%">Domestic:</td>
                                        <td>${operatings.saleDomesticEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">International:</td>
                                        <td>${operatings.saleInternationlEN}</td>
                                    </tr>
                                    <td width="15%"   >Import:</td>
                                    <td width="20%">Purchase:</td>
                                    <td><c:if test="${operatings.imports!=null}">${operatings.imports}%</c:if>&nbsp;&nbsp;${operatings.importAreaEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="15%"   >Export:</td>
                                        <td width="20%">Purchase:</td>
                                        <td><c:if test="${operatings.exports!=null&&operatings.exports!=''}">${operatings.exports}%</c:if>
                                            <c:if test="${operatings.exports==null||operatings.exports==''}"></c:if>
                                            &nbsp;&nbsp;${loperatingsist.exportAreaEN}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td width="20%">Domestic:</td>
                                        <td>${operatings.purchaseTermEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Sales:</td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">${operatings.certificationEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="15%"   >Employees:</td>
                                        <td colspan="2">${operatings.employee}</td>
                                    </tr>

                                    <tr>
                                        <td width="15%" rowspan="4"   >Facility:</td>
                                        <td width="20%">Premise:</td>
                                        <td>${operatings.premiseEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Location:</td>
                                        <td>${operatings.locationTypeEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Size:</td>
                                        <td>${operatings.size}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Ownership:</td>
                                        <td>${operatings.ownershipEN}</td>
                                    </tr>
                                    <tr>
                                        <td width="15%"   >Location:</td>
                                        <td colspan="2">${operatings.positionEN}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </c:if>
                            <c:if test="${empty operatings}">
                                <table class="table table-hover table-striped table-responsive fxq-report-table">
                                    <tbody>
                                    <tr>
                                        <td width="15%" rowspan="6"   >Business:</td>
                    ...
                    <%--Import&Export--%>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="fxqtwo">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion"
                               href="#import"
                               aria-expanded="true"
                    ...
                    <div id="import" class="panel-collapse collapse" role="tabpanel" aria-labelledby="fxqtwo">
                        <div class="panel-body">
                            <c:if test="${not empty customHouseList}">
                                <c:forEach items="${customHouseList}" var="list">
                                    <table class="table table-hover table-striped table-responsive fxq-report-table">
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>${list.customsCollectionsEN}</td>
                                        </tr>
                                        <tr>
                                            <td width="15%"   >Co Category:</td>
                                            <td>${list.managementCategoriesEN}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="color: #878787;font-size: 12px;font-style: italic">
                                                Note:
                                                <p style="width: 93%;float:right;padding-right: 20px;">
                                                    In accordance with “Measures of the Customs of the People's Republic
                                                    of China for the
                                                    Classified Management of Enterprises” published on April 1st,2008,
                                ...
                                <table class="table table-hover table-striped table-responsive fxq-report-table">
                                    ...
                                    <tr>
                                        <td colspan="2" style="color: #878787;font-size: 12px;font-style: italic">
                                            Note:
                                            <p style="width: 93%;float:right;padding-right: 20px;">
                                                In accordance with “Measures of the Customs of the People's Republic of
                                                China for the
                                                Classified Management of Enterprises” published on April 1st,2008, the
                                                followings are the
                                                Company Category Definition by General Customs:
                                                <br>AA: Excellent
                                                <br>A: Good
                    ...
                    <%--Industry--%>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="fxqthr">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion"
                               href="#industryblock"
                               aria-expanded="true"
                    ...
                    <div id="industryblock" class="panel-collapse collapse" role="tabpanel" aria-labelledby="fxqthr">
                        <div class="panel-body">
                            <c:if test="${not empty registrationInfos}">
                                <table class="table table-hover table-striped table-responsive fxq-report-table">
                                    <tbody>
                                    <tr>
                                        <td width="20%"   >Chinese (CSIC):</td>
                                        <td>${registrationInfos.chnCode}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%"   >American (ISIC):</td>
                                        <td>${registrationInfos.usCode}</td>
                                    </tr>
                                    <tr>
                                        <td width="20%"   >European (NACE):</td>
                                        <td>${registrationInfos.euCode}</td>
                                    </tr>
                                    <tr>
                            ...
                            <c:if test="${empty registrationInfos}">
                                <table class="table table-hover table-striped table-responsive fxq-report-table">
                                    <tbody>
                                    <tr>
                                        <td width="20%"   >Chinese (CSIC):</td>
                    ...
                    <%--Bank Reference--%>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="fxqfour">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion"
                               href="#bank"
                               aria-expanded="true"
                    ...
                    <div id="bank" class="panel-collapse collapse" role="tabpanel" aria-labelledby="fxqfour">
                        <div class="panel-body">
                            <c:if test="${not empty bankInfosList}">
                                <c:forEach items="${bankInfosList}" var="list">
                                    <table class="table table-hover table-striped table-responsive fxq-report-table">
                                        <tbody>
                                        <tr>
                    ...
                    <%--Payment History--%>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="fxqfive">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion"
                               href="#payment"
                               aria-expanded="true"
                    ...
                    <div id="payment" class="panel-collapse collapse" role="tabpanel" aria-labelledby="fxqfive">
                        <div class="panel-body">
                            <c:if test="${not empty paymentHistoriesList}">
                                <c:forEach items="${paymentHistoriesList}" var="list">
                                    <table class="table table-hover table-striped table-responsive fxq-report-table">
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">${list.mainSuppliersEN}</td>
                                        </tr>
                                        <tr>
                                            <td width="15%"   >Payment Mode:</td>
                                            <td colspan="3">${list.paymentMethodEN}</td>
                                        </tr>
                                        <tr>
                                            <td width="15%"   >Delinquent:</td>
                                            <td colspan="3">${list.paymentEN}</td>
                                        </tr>
                                        <tr>
                                            <td width="15%"   >Debt Collection:</td>
                                            <td colspan="3">${list.collectionEN}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </c:forEach>
                            </c:if>
                            <c:if test="${empty paymentHistoriesList}">
                                <table class="table table-hover table-striped table-responsive fxq-report-table">
                                    <tbody>
                                    <tr>
                                        <td width="15%"   >Company Name:</td>
                    ...
                    <%--Trade Reference--%>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="fxqsix">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion"
                               href="#trade"
                               aria-expanded="true"
                    ...
                    <div id="trade" class="panel-collapse collapse" role="tabpanel" aria-labelledby="fxqsix">
                        <div class="panel-body">
                            <table class="table table-hover table-striped table-responsive fxq-report-table">
                                <tbody>
                                <c:if test="${not empty suppliersinfosList}">
                                    <c:forEach items="${suppliersinfosList}" var="list">
                                        <tr>
                                            <td width="15%"   >Company Name:</td>
                                            <td>${list.nameEN}</td>
                                            <td width="15%"   >Crefo Nr.:</td>
                                ...
                                <c:if test="${not empty clientinfosList}">
                                    <c:forEach items="${clientinfosList}" var="list">
                                        <tr>
                                            <td width="15%"   >Company Name:</td>
                                            <td>${list.nameEN}</td>
                                            <td width="15%"   >Crefo Nr.:</td>
