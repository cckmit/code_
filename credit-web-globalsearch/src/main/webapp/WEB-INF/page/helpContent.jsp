...
<head>
    ...
    <meta charset="utf-8">
    <title>Full Search - Help Content</title>
...
<%--<div class="container">--%>
    <%--&lt;%&ndash;         <jsp:include page="${basePath}../include/customer/left.jsp"/>--%>
     <%--&ndash;%&gt;--%>

    <%--<div >--%>
        <%--<p class="lead">Help Content</p>--%>
    <%--</div>--%>
...
<div class="container">
    ...
    <div id="banner">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="bs-component" style="border: 1px solid #dddddd;-webkit-border-radius: 4px;-moz-border-radius:4px ;border-radius: 4px;">
                    <div style="line-height: 40px;font-weight: bold;border-bottom: 1px solid #dddddd;padding-left: 15px;">
                        Title:&nbsp;If the problem cannot be solved, please
                    </div>
                    <div style="height: 213px;overflow: auto;padding: 10px 15px;">
                        ${help}
                    </div>
