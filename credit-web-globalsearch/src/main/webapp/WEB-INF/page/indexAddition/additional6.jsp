...
<head>
    ...
    <meta charset="utf-8">
    <title>Full Search - INDUSTRY ANALYSIS</title>
...
<script type="text/javascript">
    ...
    function buttonClick() {
        ...
        if ($('#industryName').val()==null||$('#industryName').val()==''){
            BootstrapDialog.alert("The trade name cannot be empty");
            return false;
        }
        if ($('#region').val()==null||$('#region').val()==''){
            BootstrapDialog.alert("The area cannot be empty");
            return false;
        }
        ...
        <div class="span12">
            <div class="carousel-inner fxq-carousel-inner">
                <div class="item active">
                    <img alt="" src="<%=basePath%>images/site/f5.png" />
            ...
            <div class="well bs-component">
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <%--行业名称--%>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Industry Name</label>

                            <div class="col-lg-10">
                                <input class="form-control"  placeholder="Please enter the industry name" type="text" id="industryName">
                            </div>
                        </div>
                        <%--地区--%>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control"  placeholder="Plase enter the region" type="text" id="region">
                            </div>
                        </div>
                        <%--关键字--%>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 col-lg-offset-2" align="center" style="margin-left: 0;">
                                <a  class="btn btn-default" href="http://www.3arating.com" target="_blank">
                                    More Information...
                                </a>
