...
<head>
    ...
    <meta charset="utf-8">
    <title>Full Search - O2C Solutions</title>
...
<div class="container">
  ...
  <div class="col-lg-8" style=" line-height:24px">
      ...
      <p> Monitor your trade partners’ Business Credit</p>
        ...
        <div class="bs-component">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li  class="active"><a href="toIndexAddition11.do">O2C Solutions</a></li>
            </ul>
        </div>
    </div>
