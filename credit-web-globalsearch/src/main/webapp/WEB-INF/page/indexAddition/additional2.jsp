...
<head>
    ...
    <meta charset="utf-8">
    <title>Full Search - FIELD VERIFICATION</title>
        ...
        <div class="span12">
            <div class="carousel-inner fxq-carousel-inner">
                <div class="item active">
                    <img alt="" src="<%=basePath%>images/site/f1.png" />
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input class="form-control"  placeholder="Please enter the province" type="text" name="province" id="province" value="${provinceEN}">
                            </div>
                            <label class="col-lg-1 control-label">City</label>
                            <div class="col-lg-5">
                                <input class="form-control"  placeholder="Please enter the market" type="text" name="city" id="city" value="${cityEN}">
                            </div>
                        </div>
                        <%--关键字--%>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control"  placeholder="Please enter the keywords" type="text" name="keyword" id="keyword">
                            </div>
                        </div>
                        <%--需求--%>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <textarea class="form-control" rows="3" placeholder="Please enter your requirement" name="demand" id="demand"></textarea>
                            </div>
                        </div>
                        <%--按钮--%>
                        <div class="form-group">
                            <div class="col-lg-12 col-lg-offset-2" align="center" style="margin-left: 0;">
                                <a  class="btn btn-default" href="http://www.3averify.com/" target="_blank">
                                    More Information...
                                </a>
