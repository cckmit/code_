...
<head>
    ...
    <meta charset="utf-8">
    <title>Full Search - DEBT COLLECTION</title>
...
<script type="text/javascript">
    ...
    function buttonClick() {
        ...
        if ($('#amount').val()==null||$('#amount').val()==''){
            BootstrapDialog.alert("The amount cannot be null");
            return false;
        }
        ...
        <div class="span12">
            <div class="carousel-inner fxq-carousel-inner">
                <div class="item active">
                    <img alt="" src="<%=basePath%>images/site/f4.png" />
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control"  placeholder="Company Name" type="text" id="companyName" value="${companyNameEN}">
                            </div>
                        </div>
                        <%--省市--%>
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input class="form-control"  placeholder="Please enter the province" type="text" id="province" value="${provinceEN}">
                            </div>
                            <label class="col-lg-1 control-label">City</label>
                            <div class="col-lg-5">
                                <input class="form-control"  placeholder="Please enter the market" type="text" id="city" value="${cityEN}">
                            </div>
                        </div>
                        <%--金额--%>
                        <div class="form-group">
                            <label  class="col-lg-2 control-label">Amount of Money</label>

                            <div class="col-lg-10">
                                <input class="form-control"  placeholder="Please enter the amount" type="text" id="amount">
                            </div>
                        </div>
                        <%--关键字--%>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-12 col-lg-offset-2" align="center" style="margin-left: 0;">
                                <a class="btn btn-default" href="http://www.3acollect.com" target="_blank">
                                    More Information...
                                </a>
