...
public class ServiceGlobalEagleProvider {
	
	private static final Log log = LogFactory.getLog(ServiceGlobalEagleProvider.class);
	...
	public static void main(String[] args) {
		...
		synchronized (ServiceGlobalEagleProvider.class) {
			while (true) {
				try {
					ServiceGlobalEagleProvider.class.wait();
