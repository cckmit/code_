...
;(function ($, window, undefined)
{
    ...
    */
    ...
    function renderRows(rows)
    {
        if (rows.length > 0)
        {
            ...
            $.each(rows, function (index, row)
            {
                ...
                var _status = row._status != null && that.options.statusMapping[row._status];
                if (_status)
                {
                    rowCss += _status;
                }
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "All",
            infos: "共计  {{ctx.total}}  个报告，当前显示第  {{ctx.end}}  报告",
        ...
        /**
         * Specifies the mapping between _status and contextual classes to color rows.
         *
