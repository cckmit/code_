                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="creditChoose" id="optionsRadios1" value="电话认证"
                                               checked="checked" type="radio" style="width: 16px;height: 16px;">
                                        电话认证
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="creditChoose" id="optionsRadios2" value="实地认证" type="radio" style="width: 16px;height: 16px;">
                                        实地认证
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <div class="radio">
                                    <label>
                                        <input name="creditChoose" id="optionsRadios3" value="特殊认证" type="radio" style="width: 16px;height: 16px;">
                                        特殊认证
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="radio">
                                    ...
                                    <input class="form-control" id="company_country" name="country" placeholder="输入国家/地区名称" type="text" value="${creditServices.country}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="enableOrder" value="true"   style="width: 16px;height: 16px;"> 是否订制过目标企业商业资信报告
                                    </label>
                                </div>
                            </div>
                        </div>
