						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-9">
									...
									<div class="checkbox">
										<label> <input type="checkbox" class="btn btn-primary" style="width: 16px;height: 16px;">需要开具发票
										</label>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-9">
									<div class="radio">
										<label> <input name="optionsRadios"
											...
											type="radio" class="btn btn-primary" style="width: 16px;height: 16px;"> 支付宝
										</label>
									</div>
<!-- 									<div class="radio">
										<label> <input name="optionsRadios"
			...
			<div class="col-lg-4 col-lg-offset-1">
				...
				<form class="bs-component" action="<%=basePath%>simple/login.do" id="myForm" method="post">
					...
					<%--<div class="form-group">--%>
						...
						<%--<a href="javascript:void(0);" onclick="changeImg()">换一张</a>&ndash;%&gt;--%>

						<%--&lt;%&ndash;<div class="col-lg-9">&ndash;%&gt;--%>
							<%--&lt;%&ndash;<input&ndash;%&gt;--%>
									<%--&lt;%&ndash;class="form-control" placeholder="验证码" name="verificationCode" id="verificationCode" required&ndash;%&gt;--%>
									<%--&lt;%&ndash;type="text">&ndash;%&gt;--%>
							<%--&lt;%&ndash;<img id="imgObj" class="verifyCode"  alt="" src="<%=basePath%>xuan/verifyCode.do" onclick="changeImg()"/>&ndash;%&gt;--%>
							<%--&lt;%&ndash;<a href="javascript:void(0);" onclick="changeImg()">换一张</a>&ndash;%&gt;--%>
						<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
					<%--</div>--%>
<br>
					<div class="form-group">
...
<!-- 						<a href="＃">忘记用户名或密码</a>
 -->					</div>
					<div class="form-group" align="center" style="padding-top: 40px">
