    ...
    <div id="banner">
        ...
        <table id="orderDetailGrid" class="table table-hover table-bordered table-responsive">
            ...
            <tr>
                ...
                <th data-column-id="countryCnName" data-type="string" data-width="10%">国家</th>
                ...
                <th data-column-id="createDate" data-formatter="createDate" data-type="string" data-width="13%">下单日期</th>

                <th data-column-id="orderStatusId" data-formatter="orderStatusId" data-type="string" data-width="12%">订单状态</th>
