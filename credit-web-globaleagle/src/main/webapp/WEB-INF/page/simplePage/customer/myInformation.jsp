...
--%>
        <div class="well bs-component">
            <form class="form-horizontal" action="<%=basePath%>simple/customer/changedInformation.do" method="post">
            <fieldset>
                <legend>个人信用信息
                ...
                <%--<div class="form-group">--%>
                    <%--<div class="col-lg-12 text-center">--%>
                        <%--<a class="btn btn-danger" href="<%=basePath%>toApproveCompany.do" ><h3>免费认证企业，获取更优惠价格及更好的服务</h3></a>--%>
                    <%--</div>--%>
                <%--</div>--%>
            </fieldset>
            </form>
