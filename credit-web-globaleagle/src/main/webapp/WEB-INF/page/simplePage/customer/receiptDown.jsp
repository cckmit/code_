...
<div style="width:320px; height:150px; float:right;border:2px solid #dddddd;">
        <div style="width:320px; height:30px; float:right; background-color:#CCC;">
            <div id="user">订单信息</div></div>
        <p id="user">订单日期: ${orderCreateTime}<br>
            订单编号: ${order.orderNo}<br>
            订单总额：${order.getPrice()}<br>
            订单数量： ${order.getOrderDetailCount()}</p>
    </div>
    </c:if>
</div>
