        ...
        <div class="bs-component">
            ...
            <div id="myTabContent" class="tab-content">
                                ...
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse61"
                                       ...
                                       aria-controls="collapse61">
                                        <span class="formleft"><strong>Other Address</strong></span>（<c:if test="${empty searchDetail.contactInformation.otherAddresses.otherAddress}">0</c:if>
                ...
                <div class="tab-pane fade active in" id="tab09">
                    <div class="row">
                        <jsp:include page="${basePath}../../creditsafe/additional/additional_GB.jsp"/>
                    </div>
                </div>
                <%
                    }
