        ...
        <div id="addtional5" class="panel-collapse collapse" role="tabpanel"
            ...
            <div class="panel-body">
                <table width="100%"
                    ...
                    <tbody>
                        <tr>
                            <td>${searchDetail.additionalInformation.negativeInformation.bankruptcyData.hasBankruptcy.hasBankruptcyExactNameAndAddressMatch}</td>
                            <td>${searchDetail.additionalInformation.negativeInformation.bankruptcyData.hasBankruptcy.hasBankruptcyExactAddressMatch}</td>
                            <td>${searchDetail.additionalInformation.negativeInformation.bankruptcyData.hasBankruptcy.hasBankruptcyExactNameMatch}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
