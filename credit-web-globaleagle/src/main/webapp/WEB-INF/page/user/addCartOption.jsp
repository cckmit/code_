        ...
        <div class="row">
            <div class="well bs-component">
                ...
                <form class="form-horizontal" id="formAction"
                      action="<%=basePath%>user/addCart.do" method="post"
                      onsubmit="return checkForm();">
                    <input id="currency" type="hidden" name="currency" value="cny">
                    ...
                    <fieldset>
                        ...
                        <table class="table table-striped table-responsive">
                            ...
                            <tr>
                                <td bgcolor="#FFFFFF"><input name="choose" type="radio"
                                                             value="online" id="onCheckBox"></td>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                    ...
                                    >
                                <input type="button" class="btn btn-primary" value="马上支付"
                                       onclick="payFo();" style="width: 130px;">
