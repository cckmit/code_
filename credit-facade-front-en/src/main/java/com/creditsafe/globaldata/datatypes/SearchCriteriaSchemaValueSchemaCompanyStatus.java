...
/**
 * <p>SearchCriteriaSchema.ValueSchema_CompanyStatus complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SearchCriteriaSchema.ValueSchema_CompanyStatus"&gt;
 *   &lt;complexContent&gt;
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="AllowedValue" type="{http://www.creditsafe.com/globaldata/datatypes}CompanyStatus" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "SearchCriteriaSchema.ValueSchema_CompanyStatus", propOrder = {
    "allowedValues",
    "validationRegExp"
})
public class SearchCriteriaSchemaValueSchemaCompanyStatus  implements Serializable {
