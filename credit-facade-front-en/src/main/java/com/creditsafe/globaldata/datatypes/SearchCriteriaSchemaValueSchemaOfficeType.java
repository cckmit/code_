...
/**
 * <p>SearchCriteriaSchema.ValueSchema_OfficeType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SearchCriteriaSchema.ValueSchema_OfficeType"&gt;
 *   &lt;complexContent&gt;
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="AllowedValue" type="{http://www.creditsafe.com/globaldata/datatypes}OfficeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "SearchCriteriaSchema.ValueSchema_OfficeType", propOrder = {
    "allowedValues",
    "validationRegExp"
})
public class SearchCriteriaSchemaValueSchemaOfficeType implements Serializable {
    ...
    public static class AllowedValues {
        ...
        protected List<OfficeType> allowedValue;
         ...
         * 
         */
        public List<OfficeType> getAllowedValue() {
            if (allowedValue == null) {
                allowedValue = new ArrayList<OfficeType>();
            }
