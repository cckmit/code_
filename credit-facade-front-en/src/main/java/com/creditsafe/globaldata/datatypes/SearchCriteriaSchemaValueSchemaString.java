...
/**
 * <p>SearchCriteriaSchema.ValueSchema_String complex type的 Java 类。
 * 
...
@XmlType(name = "SearchCriteriaSchema.ValueSchema_String", propOrder = {
    "allowedValues",
    "validationRegExp"
})
@XmlSeeAlso({
...
public class SearchCriteriaSchemaValueSchemaString implements Serializable {
