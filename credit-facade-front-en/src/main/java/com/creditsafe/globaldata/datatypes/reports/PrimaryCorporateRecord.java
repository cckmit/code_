...
@XmlType(name = "PrimaryCorporateRecord", propOrder = {
	"businessLegalName",
	"sosCharterNumber",
	"status",
	"incorporatedState",
...
public class PrimaryCorporateRecord implements Serializable {
	...
	@XmlElement(name = "PrincipalState")
	protected String principalState;
	public String getPrincipalState() {return principalState;}
	public void setPrincipalState(String value) {this.principalState =  value;}
