...
import com.creditsafe.globaldata.datatypes.CurrentPortfolioMonitoringRules;
...
@XmlRootElement(name = "GetMonitoringRulesResponse")
public class GetMonitoringRulesResponse {
    ...
    /**
     * 获取getMonitoringRulesResult属性的值。
     * 
     * @return
     *     possible object is
    ...
    /**
     * 设置getMonitoringRulesResult属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link CurrentPortfolioMonitoringRules }{@code >}
