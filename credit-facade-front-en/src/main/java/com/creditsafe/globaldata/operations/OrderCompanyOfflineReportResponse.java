...
import com.creditsafe.globaldata.datatypes.ReportOrder;
...
@XmlRootElement(name = "OrderCompanyOfflineReportResponse")
public class OrderCompanyOfflineReportResponse {
    ...
    /**
     * 获取orderCompanyOfflineReportResult属性的值。
     * 
     * @return
     *     possible object is
    ...
    /**
     * 设置orderCompanyOfflineReportResult属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ReportOrder }{@code >}
