 ...
 */
@Service("emailServiceReportImpl")
public class EmailServiceReportImpl implements EmailServiceGE {

    private static Logger logger = Logger.getLogger(EmailServiceReportImpl.class);
    ...
    public MailSenderInfo generateForgetContent(String dataUrl, String dataToAddress) {
        ...
        mailSenderInfo.setContent("<!DOCTYPE html>\n" +
                ...
                "\t\t\t\t<span style=\"color: #0872b0\">Autom</span>\n" +
                "\t\t\t\t<span style=\"color: #0872b0\">欢迎使用全球鹰</span>\n" +
                "\t\t\t</li>\n" +
                "\t\t\t<li style=\"font-size: 14px;line-height: 50px\">\n" +
                "\t\t\t    报告已发送成功，请点击下方链接查看\n" +
                "\t\t\t</li>\n" +
