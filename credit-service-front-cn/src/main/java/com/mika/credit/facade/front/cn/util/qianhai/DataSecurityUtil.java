...
//        	System.out.println("这是公钥");
            String filePath = DataSecurityUtil.class.getResource("/QHKey/credoo_stg.cer").getPath();
            logger.debug("前海 Key filePath = "+filePath);
            //String filePath = Thread.currentThread().getContextClassLoader().getResource("").getPath()+"QHKey/credoo_stg.cer";
    ...
    private static PrivateKey getPrivateKey() throws Exception
    {
        ...
        try
        {
//        	System.out.println("这是私钥");
            KeyStore ks = KeyStore.getInstance("JKS");
            String filePath = DataSecurityUtil.class.getResource("/QHKey/3acredit_stg.jks").getPath();
            logger.debug("前海 Key filePath = "+filePath);
            FileInputStream fis = new FileInputStream(filePath);
            bis = new BufferedInputStream(fis);
//            String storePassword = "weblogic1";

            String storePassword = "3acredit_2016";
            String storeAlias = "3acredit";
